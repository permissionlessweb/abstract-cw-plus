...
use cosmwasm_std::{
    from_json, to_json_binary, Addr, Binary, Deps, DepsMut, Env, IbcMsg, IbcQuery, MessageInfo,MigrateInfo,
...
#[cfg_attr(not(feature = "library"), entry_point)]
pub fn migrate(mut deps: DepsMut, env: Env, msg: MigrateMsg, _info: MigrateInfo) -> Result<Response, ContractError> {
...
mod test {
    ...
    fn setup_and_query() {
        ...
        .unwrap_err();
        assert_eq!(err.to_string(), StdError::msg("type: abstract_cw20_ics20::state::ChannelInfo; key: [00, 0C, 63, 68, 61, 6E, 6E, 65, 6C, 5F, 69, 6E, 66, 6F, 63, 68, 61, 6E, 6E, 65, 6C, 2D, 31, 30] not found").to_string());
    }
